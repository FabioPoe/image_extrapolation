...
class RandomSeqDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # choosing borders,
        # i choose the same borders x and y, because in the example testset it is the same
        ...
        input_array, known_array, target_array, original_array = ex4(np_trafo_img, border, border)

        # Let's say that our `index` is the sample ID
        sample_id = index
        # Return the sample, this time with label
        return input_array, known_array, target_array, sample_id, original_array
